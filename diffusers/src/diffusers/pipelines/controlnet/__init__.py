...
try:
    ...
    _import_structure["pipeline_controlnet_BDM"] = ["StableDiffusionControlNetPipelineBDM"]
    ...
    _import_structure["pipeline_controlnet_sd_xl_BDM"] = ["StableDiffusionXLControlNetPipelineBDM"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_controlnet_BDM import StableDiffusionControlNetPipelineBDM
        ...
        from .pipeline_controlnet_sd_xl_BDM import StableDiffusionXLControlNetPipelineBDM
